...
export const AboutSection = ({ forwardedRef }: { forwardedRef: React.RefObject<HTMLDivElement> }) => {
  ...
  return (
    <section ref={forwardedRef} className="py-16 md:py-24 relative overflow-hidden bg-gradient-to-b from-white to-blue-50">
      {/* Subtle background elements */}
      <div className="hidden md:block absolute top-40 right-10 w-64 h-64 rounded-full bg-blue-100/30"></div>
      <div className="hidden md:block absolute bottom-40 left-10 w-48 h-48 rounded-full bg-blue-100/20"></div>
      ...
      <div className="container mx-auto px-4 relative">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-800 mb-4">
            Nuestro <span className="text-blue-700 relative inline-block">
              Equipo
          ...
          <div className="bg-white rounded-2xl overflow-hidden shadow-lg border border-gray-100">
            ...
            <div className="p-6 md:p-8 lg:p-10">
              ...
              <div className="flex flex-col items-center text-center mb-10">
                <div className="inline-flex bg-blue-50 p-4 rounded-full mb-5">
              ...
              <div className="bg-gradient-to-r from-blue-50 to-blue-100/50 p-5 rounded-xl flex flex-col md:flex-row items-center justify-center md:justify-around gap-6">
                <div className="flex items-center">
                  ...
                  <div>
                    <h5 className="font-bold text-gray-800">Formación Universitaria</h5>
                    <p className="text-gray-600 text-sm">Graduados de la Universidad de Buenos Aires (UBA)</p>
                  </div>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    <h5 className="font-bold text-gray-800">Experiencia Comprobada</h5>
                    <p className="text-gray-600 text-sm">Especialistas en derecho penal y laboral</p>
                  </div>
                </div>
              </div>
            </div>
